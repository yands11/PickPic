...
import com.blank.pickpic.presentation.newup.NewUpViewModelProviderFactory


class NewUpFragment : Fragment() {

    private lateinit var binding: NewUpFragmentBinding
    private val vmProvider = NewUpViewModelProviderFactory()
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? =
        NewUpFragmentBinding.inflate(inflater, container, false).also {
            ...
            vm = viewModelProvider<NewUpViewModel>(vmProvider)
        }.root
